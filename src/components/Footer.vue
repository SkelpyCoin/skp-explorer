<template>
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0">
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; <a href="https://www.skelpy.co"> skelpy.co | {{ year }}. {{ $t("All rights reserved") }}</a> </span> <div class="block md:inline-block"><span class="hidden md:inline-block"> | </span> <span>{{ $t("Version") }}: <a :href="versionLink" target="_blank">{{ version }}</a> | {{ $t("Date") }}: {{ date }}</span></div>
    </div>
    <div class="text-center">

      <a href="https://twitter.com/skelpycoin">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
      ...
      <a href="https://t.me/skelpycoin" target="_blank">
        <svg
          viewBox="0 0 14 14"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://github.com/skelpycoin" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://join.slack.com/t/skelpy/" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://gitter.im/skelpycoin/skelpycoin">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://medium.com/skelpycoin" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
...
export default {
  computed: {
    ...
    versionLink() {
      return `https://github.com/skelpycoin/skp-explorer/commit/${GIT_VERSION}`
    },
    date() {
      return GIT_DATE
    }
